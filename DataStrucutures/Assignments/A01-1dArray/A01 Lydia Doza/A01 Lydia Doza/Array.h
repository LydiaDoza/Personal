...
/**********************************************************************
* Purpose:	Copies data from passed in copy
...
* Purpose:	Dtor
* Entry:	None.
* Exit:		Data members set to default values
************************************************************************/
template <typename T>
Array<T>::~Array()
{
...
/**********************************************************************
* Purpose:	op equals sets lhs data equal to rhs data
...
/**********************************************************************
* Purpose:	overloads the [] operator so that you can access the array
