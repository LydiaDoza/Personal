...
void BinarySearchTree<T>::DeleteByCopy(BSTNode<T> *& node)
{
	...
	else if (node->m_left_subtree == nullptr && node->m_right_subtree == nullptr)
	{
		delete node;
		node = nullptr;
	}
...
************************************************************************/
template <typename T>
void BinarySearchTree<T>::TravInOrder(void(*Visit)(BSTNode<T>*), BSTNode<T>* root)
{
	if (root != nullptr)
	{
...
************************************************************************/
template <typename T>
void BinarySearchTree<T>::TravPreOrder(void(*Visit)(BSTNode<T>*), BSTNode<T>* root)
{
	if (root != nullptr)
	{
		Visit(root);
...
************************************************************************/
template <typename T>
void BinarySearchTree<T>::TravPostOrder(void(*Visit)(BSTNode<T>*), BSTNode<T>* root)
{
	if (root != nullptr)
	{
