...
*		two/one arg ctor sets m_length to length and 
*		m_start_index to start_index (if no input, set to 0)
...
*		overloads [] operator to support native array
*		notation
*	const T& operator[](int index) const;
*		Same as above but called from constant objects
*	int GetStartIndex();
*		returns start index
*	void SetStartIndex(int start_index);
*		sets start index ( beginning element is still 
*		accessed as 0)
*	int GetLength();
*		Returns total array length
*	void SetLength(int length);
*		sets total array length (possible loss of data)
************************************************************/
#ifndef ARRAY_H
#define ARRAY_H
